...
const ThemeSwitch = () => {
  ...
  return (
    <div>
      <div className='relative inline-grid h-5 grid-cols-[1fr_1fr] items-center px-1 rounded-md text-sm font-medium'>
        <Switch
          checked={checked}
        ...
        />
        <span className='pointer-events-none relative flex min-w-8 items-center justify-end text-center transition-transform duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] peer-data-[state=checked]:invisible peer-data-[state=unchecked]:translate-x-6 peer-data-[state=unchecked]:rtl:-translate-x-6'>
          <Moon className='size-4 text-white' aria-hidden='true' />
        </span>
