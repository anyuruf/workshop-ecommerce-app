    ...
    <div>
      <div className='relative inline-grid h-4 grid-cols-[1fr_1fr] items-center px-1 rounded-md text-sm font-medium'>
        <Switch
          ...
          className='peer absolute inset-0 h-[inherit] data-[state=unchecked]:bg-sidebar-foreground/96 w-auto rounded-md [&_span]:z-10 [&_span]:h-full [&_span]:w-1/2 [&_span]:rounded-md [&_span]:transition-transform [&_span]:duration-300 [&_span]:ease-[cubic-bezier(0.16,1,0.3,1)] [&_span]:data-[state=checked]:translate-x-6.76 [&_span]:data-[state=checked]:rtl:-translate-x-8.75'
          aria-label='Square switch with permanent text indicators'
        />
        <span className='pointer-events-none relative flex min-w-6 items-center justify-end text-center transition-transform duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] peer-data-[state=checked]:invisible peer-data-[state=unchecked]:translate-x-4 peer-data-[state=unchecked]:rtl:-translate-x-4'>
          <Moon className='size-3 text-white' aria-hidden='true' />
        </span>
