...
export default function HomePage() {
  return (
    <main className="grid relative">
      ...
      <div className="h-dvh col-span-full max-w-7xl mx-auto row-span-2 row-start-1" />
      ...
      {/* Main content */}
      <section className="grid grid-cols gap-14 row-start-2 col-start-1 px-2 md:px-4 xl:px-6">
        <HeroCarousel />
